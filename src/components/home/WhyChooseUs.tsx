      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {points.map((point, i) => (
            ...
            >
              <div className="w-12 h-12 flex items-center justify-center shrink-0 text-[#DC0218] bg-[#FFF5EC] border border-[#F9D976] shadow-[0_4px_12px_rgba(249,217,118,0.2)] rounded-full transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_6px_20px_rgba(249,217,118,0.35)]">
                {point.svg}
              </div>
