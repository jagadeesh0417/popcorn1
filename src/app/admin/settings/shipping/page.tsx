        ...
        <div className="px-8 py-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <button onClick={() => toggle("freeShippingEnabled")}
                  className={`relative w-10 h-5 transition-colors ${settings.freeShippingEnabled ? "bg-[#B71C1C]" : "bg-[#E0E0E0]"}`}>
              ...
              <div className="space-y-3">
                <div className="space-y-1.5">
                  ...
                  <Input type="number" value={settings.freeShippingThreshold}
                    ...
                    className="bg-white border-[rgba(183,28,28,0.12)]" />
                </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
              ...
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2">
                  <IndianRupee className="h-5 w-5 text-[#B71C1C]" />
                  <h3 className="font-bold text-lg text-[#1A1A1A]">Delivery Charges</h3>
                </div>
                <button onClick={() => toggle("panIndiaShippingEnabled")}
                  className={`relative w-10 h-5 transition-colors ${settings.panIndiaShippingEnabled ? "bg-[#B71C1C]" : "bg-[#E0E0E0]"}`}>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => toggle("mysuruPickupEnabled")}
                    className={`relative w-10 h-5 transition-colors ${settings.mysuruPickupEnabled ? "bg-[#B71C1C]" : "bg-[#E0E0E0]"}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => toggle("localMysuruDeliveryEnabled")}
                    className={`relative w-10 h-5 transition-colors ${settings.localMysuruDeliveryEnabled ? "bg-[#B71C1C]" : "bg-[#E0E0E0]"}`}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
              ...
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2">
                  <Zap className="h-5 w-5 text-[#B71C1C]" />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => toggle("expressDeliveryEnabled")}
                    className={`relative w-10 h-5 transition-colors ${settings.expressDeliveryEnabled ? "bg-[#B71C1C]" : "bg-[#E0E0E0]"}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => toggle("codEnabled")}
                    className={`relative w-10 h-5 transition-colors ${settings.codEnabled ? "bg-[#B71C1C]" : "bg-[#E0E0E0]"}`}>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="mt-8 flex justify-end">
            <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.97 }}>
              <Button onClick={() => toast.success("Shipping settings saved!")} className="bg-[#B71C1C] hover:bg-[#8E1414] text-white px-8 h-12 shadow-lg shadow-[#B71C1C]/20">
